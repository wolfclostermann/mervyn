...
use super::payloads::{
    EventTitleExtractionV1, FreeformQueryV1, IntentClassificationV1, MorningBriefingV1,
    RemoveEventCandidateV1, RemoveEventRequestV1, SystemContextV1,
};
...
Classify message into exactly one intent: add_reminder, add_event, log_work, add_note, remove_event, remember_briefing, ask.
...
- intent: one of add_reminder, add_event, log_work, add_note, remove_event, remember_briefing, ask"#;
